    ...
    <script type="text/javascript">
        ...
        function check_valid_number(adnumber) {
            ...
            if(is_num(prefix) || prefix == "X") {
                ...
                alert("The first character of the Order Number \"" + prefix + "\" must be a number an X or an A");
            }

            if(is_num(body)) {
                body_ok = true;
            } else {
                alert("Other than the first and last characters, the Order Number must only contain numbers " + body);
            }	
			
            if(is_num(postfix) || postfix == "A" || postfix == "B" || postfix == "C" || postfix == "D" || postfix == "E" || postfix == "F" || postfix == "G") {
                postfix_ok = true;
            } else {
                alert("The last character of the Order Number \"" + postfix + "\" must be a number or an A");
            }
